const p={revisionhistory_fetch:()=>Promise.resolve([{revisionId:"3",createdAt:"2023-11-24T22:26:21.578Z",author:{id:"husky",name:"A Tiny Husky",avatar:"../_images/tiny-husky.jpg"},content:`
        ...
        `},{revisionId:"1",createdAt:"2023-11-29T10:11:21.578Z",author:{id:"tiny.user",name:"A Tiny User",avatar:"../_images/logos/android-chrome-192x192.png"},content:`
          ...
          <p>Don't forget to check out our other product <a href="http://www.plupload.com" target="_blank" rel="noopener">Plupload</a>, your ultimate upload solution featuring HTML5 upload support.</p>
          <p>Thanks for supporting TinyMCE! We hope it helps you and your users create great content.<br>All the best from the TinyMCE team.</p>
        `}]),ai_request:(i,n)=>{const l={method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${window.prompt("Paste your OpenAI key here")}`},body:JSON.stringify({model:"gpt-4o",temperature:.7,max_tokens:800,messages:[{role:"user",content:i.prompt}]})};n.string(h=>window.fetch("https://api.openai.com/v1/chat/completions",{signal:h,...l}).then(async e=>{var o,r,a;if(e){const t=await e.json();if(t.error)throw new Error(`${t.error.type}: ${t.error.message}`);if(e.ok)return(a=(r=(o=t==null?void 0:t.choices[0])==null?void 0:o.message)==null?void 0:r.content)==null?void 0:a.trim()}else throw new Error("Failed to communicate with the ChatGPT API")}))}};export{p as h};
