import{c as l,j as e,p as n}from"./index-CVcHzZOf.js";import{r as t}from"./react-C_gYsUBP.js";import{A as d,a as u,B as c,b as p,c as h,C as m,E as f,G as b,I as g,L as y,d as k,e as x,M as w,P as v,f as E,g as C,R as T,S as L,h as j,T as R,U as I,i as S,j as H}from"./ckeditor-CD3WpQ63.js";function K(){const i=t.useRef(null),a=t.useRef(null),[r,o]=t.useState(!1);t.useEffect(()=>(setTimeout(()=>{console.log("Waited 2s"),o(!0)},2e3),()=>o(!1)),[]);const s={toolbar:{items:["bold","italic","underline","|","link","bulletedList","numberedList"],shouldNotGroupWhenFull:!1},plugins:[d,u,c,p,h,m,f,b,g,y,k,x,w,v,E,C,T,L,j,R,I],balloonToolbar:["bold","italic","|","link","|","bulletedList","numberedList"],htmlSupport:{allow:[{name:/^.*$/,styles:!0,attributes:!0,classes:!0}]},initialData:n()+`<b>Congratulations on setting up CKEditor 5! 🎉</b>
<p>
